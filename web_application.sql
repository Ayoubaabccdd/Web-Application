...
--
-- Host: 127.0.0.1
-- Creato il: Dic 19, 2024 alle 08:50
...
--
-- Struttura della tabella `partite disponibili`
--

CREATE TABLE `partite disponibili` (
  `ID` int(11) NOT NULL,
  `ID_UTENTE1` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Indici per le tabelle `partite disponibili`
--
ALTER TABLE `partite disponibili`
  ADD PRIMARY KEY (`ID`),
  ADD KEY `utente-partita_disp` (`ID_UTENTE1`);
...
--
-- AUTO_INCREMENT per la tabella `partite disponibili`
--
ALTER TABLE `partite disponibili`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Limiti per la tabella `partite disponibili`
--
ALTER TABLE `partite disponibili`
  ADD CONSTRAINT `utente-partita_disp` FOREIGN KEY (`ID_UTENTE1`) REFERENCES `partite disponibili` (`ID`);
COMMIT;
